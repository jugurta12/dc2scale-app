  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 space-y-3">
      ...
      <div className="relative">
        ...
        />
        {suggestions.type === 'destinataireNom' && suggestions.list.length > 0 && (
          <div className="absolute z-10 w-full bg-zinc-800 border border-zinc-700 mt-1 rounded-lg shadow-2xl overflow-hidden">
            {suggestions.list.map((s: any, i: number) => (
              <div key={i} onClick={() => selectContact(s, 'destinataireNom')} className="p-3 hover:bg-teal-500 hover:text-black cursor-pointer text-sm transition-colors">
