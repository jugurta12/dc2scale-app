...
export default function CreateDocumentPage() {
  ...
  const Sidebar = ({ breadcrumb }: { breadcrumb: string }) => (
  ...
  if (id === "7") return (
    <div className="flex min-h-screen bg-zinc-950 text-zinc-100" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-8 overflow-y-auto max-w-2xl">
          ...
          <form onSubmit={handleNdaSubmit} className="space-y-4">
            <NdaPartnerBlock formData={ndaForm} setFormData={setNdaForm} inputClass={inputClass} />
